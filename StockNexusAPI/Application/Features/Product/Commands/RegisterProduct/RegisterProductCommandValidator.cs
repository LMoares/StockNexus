    ...
    public class RegisterProductCommandValidator : AbstractValidator<RegisterProductCommand>
    {
        public RegisterProductCommandValidator()
        {
            RuleFor(x => x.Name)
                ...
                .MaximumLength(100).WithMessage("Product name cannot exced 100 characters in length");
            RuleFor(x => x.Description)
                .NotEmpty().WithMessage("Product description is Required.")
                .MaximumLength(500).WithMessage("Product description cannot exced 500 characters in length");
